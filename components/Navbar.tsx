  ...
  return (
    <>
      <nav className="bg-white container mx-auto px-4">
        <div className="">
          <div className="flex items-center  justify-between h-40">
            ...
            <div className="hidden lg:block">
              <div className="flex text-sm font-light hover:cursor-pointer">
                <a href="/" className="mr-2">
                  Shop
                </a>
                <a href="/lookbook" className="mr-2">
                  Lookbook
                </a>
        ...
        {isClick && (
          <div className="lg:hidden h-screen  w-full flex items-center justify-center">
            <div className="flex flex-col items-center space-y-6">
              <a href="/" className="text-black">
                Shop
              </a>
              <a href="/lookbook" className="text-black">
                Lookbook
              </a>
